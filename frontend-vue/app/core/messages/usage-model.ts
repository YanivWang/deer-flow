/*
  【文件职责】     见下方源码；本文件由 frontend/src/core/messages/usage-model.ts retype 而来。
  【对应 frontend/】 frontend/src/core/messages/usage-model.ts
  【架构位置】     L3
  【主要导出】     TokenUsageInlineMode / TokenUsagePreferences / TokenUsageViewPreset / TokenDebugStep / getTokenUsageViewPreset / tokenUsagePreferencesFromPreset 等 7 个
