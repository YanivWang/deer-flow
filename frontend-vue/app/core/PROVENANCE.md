...
| `i18n/locales/en-US.ts`               | `ADAPTED` | `i18n/locales/en-US.ts`                                        | WP-07–11 的 Vue-owned scheduled tasks、channels、Agents、Settings 与 workspace shell 英文词典扩展。                                                                                    |
| `i18n/locales/types.ts`               | `ADAPTED` | `i18n/locales/types.ts`                                        | WP-07–11 逐键声明对应 Vue-owned 词典扩展，不放宽其他翻译类型。                                                                                                                         |
| `i18n/locales/zh-CN.ts`               | `ADAPTED` | `i18n/locales/zh-CN.ts`                                        | WP-07–11 的匹配中文文案，逐键对齐英文。                                                                                                                                                |
