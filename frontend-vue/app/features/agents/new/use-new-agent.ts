...
import { AGENT_NAME_RE, buildNewAgentRunContext } from "../../../entities/agent/model";
...
export { buildNewAgentRunContext } from "../../../entities/agent/model";
export type { NewAgentRunContext } from "../../../entities/agent/model";
  ...
  return rawMessages.some(
    (message) =>
      ...
      (message.name === toolName ||
        (typeof message.tool_call_id === "string" && matchingToolCallIds.has(message.tool_call_id))),
  );
}
