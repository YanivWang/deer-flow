/*
  【文件职责】     见下方源码；本文件由 frontend/src/core/messages/human-input.ts retype 而来。
  【对应 frontend/】 frontend/src/core/messages/human-input.ts
  【架构位置】     L3
  【主要导出】     HumanInputMode / HumanInputOption / HumanInputFieldType / HumanInputField / HumanInputFormValue / HumanInputRequest 等 22 个
...
export type HumanInputMode =
  "free_text" | "single_choice" | "choice_with_other" | "form";
