...
description: 当用户请求生成、创建、构想或可视化图像、角色、场景、产品或视觉内容时使用此 skill。支持结构化提示词和参考图引导。
---

# image-generation Skill（中文可替换运行版）

## 中文执行摘要

Agent 负责构造结构化英文视觉 prompt 和参考图路径，Python 脚本负责选择 Gemini 或 MiniMax 并写出图片文件。
