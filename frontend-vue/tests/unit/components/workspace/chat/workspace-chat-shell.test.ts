...
import WorkspaceChatShell from "../../../../../app/components/workspace/chat/WorkspaceChatShell.vue";
...
describe("WorkspaceChatShell", () => {
  it("keeps the sidebar and main chat regions as stable layout boundaries", () => {
    ...
    expect(wrapper.get(".workspace-chat__utility-bar").text()).toBe("utility content");
