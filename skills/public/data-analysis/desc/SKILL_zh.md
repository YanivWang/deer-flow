---
name: data-analysis
description: 当用户上传 Excel 或 CSV 并希望进行数据分析、统计汇总、透视表、SQL 查询或结构化数据探索时使用此 skill。
---

# data-analysis Skill（中文可替换运行版）

## 中文执行摘要

把 Excel/CSV 输入交给 Python 分析脚本完成清洗、探索、聚合和导出，再用 Markdown/CSV/JSON 等形式交付结果。
